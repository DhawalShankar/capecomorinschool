...
// Simple inline SVG icons to avoid lucide-react export issues
...
// lucide-react has no WhatsApp brand icon, so a small inline SVG is used instead
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-5">
            <a
              ...
              aria-label="Cape Comorin School on Facebook"
              className="text-[#C9C4B8] hover:text-[#C9A227] transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Cape Comorin School on Instagram"
              className="text-[#C9C4B8] hover:text-[#C9A227] transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Cape Comorin School on LinkedIn"
              className="text-[#C9C4B8] hover:text-[#C9A227] transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Chat with Cape Comorin School on WhatsApp"
              className="text-[#C9C4B8] hover:text-[#C9A227] transition-colors"
            >
